...
interface DirectChatAssistantProps {
  user: any;
}

export function DirectChatAssistant({ user }: DirectChatAssistantProps) {
  ...
  const sendMessage = async () => {
    ...
    try {
      // Prepare messages for the existing /api/chat endpoint
      ...
      const assistantMessage: Message = {
        ...
        role: 'assistant',
        content: data.message || 'I apologize, but I couldn\'t process your request right now. Please try again.',
        timestamp: new Date()
      };
